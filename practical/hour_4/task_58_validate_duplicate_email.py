"""
PRACTICAL SOLUTION: Custom Validator for Duplicate Email Addresses (FLASK-H4-P13)
====================================================
ID: FLASK-H4-P13
...
Explanation:
Query User.query.filter_by(email=field.data).first() and raise ValidationError if found.
"""
