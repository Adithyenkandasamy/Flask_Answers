"""
PRACTICAL SOLUTION: Appending Items to User Relationship Collection (FLASK-H3-P11)
====================================================
ID: FLASK-H3-P11
...
Explanation:
Calling user.items.append(item) establishes the bidirectional relationship automatically.
"""
