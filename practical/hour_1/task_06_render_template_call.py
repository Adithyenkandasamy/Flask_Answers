"""
PRACTICAL SOLUTION: Template Context Variable Passing (FLASK-H1-P06)
====================================================
ID: FLASK-H1-P06
...
Explanation:
Pass items=items keyword argument to render_template_string so Jinja can iterate over it.
"""
